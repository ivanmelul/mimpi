...
class ControllerCatalogProduct extends Controller {
    ...
    private function getForm() {
        ...
        if (isset($this->request->post['colores'])) {
            $this->data['colores'] = $this->request->post['colores'];
        } elseif (!empty($product_info)) {
        ...
        if (isset($this->request->post['colores']) && file_exists(DIR_IMAGE . $this->request->post['colores'])) {
            $this->data['colores_thumb'] = $this->model_tool_image->resize($this->request->post['colores'], 100, 100);
        } elseif (!empty($product_info) && $product_info['colores'] && file_exists(DIR_IMAGE . $product_info['colores'])) {
            $this->data['colores_thumb'] = $this->model_tool_image->resize($product_info['colores'], 100, 100);
        } else {
            $this->data['colores_thumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
        }
