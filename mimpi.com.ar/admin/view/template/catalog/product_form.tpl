      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td>Colores</td>
              <td><div class="image"><img src="<?php echo $colores_thumb; ?>" alt="" id="colores_thumb" /><br />
                  <input type="hidden" name="colores" value="<?php echo $colores; ?>" id="colores" />
                  <a onclick="image_upload('colores', 'colores_thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#colores_thumb').attr('src', '<?php echo $no_image; ?>'); $('#colores').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  <td class="left"><select id="selectColor" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]">
                      <?php if (isset($option_values[$product_option['option_id']])) { ?>
                      <?php foreach ($option_values[$product_option['option_id']] as $option_value) { ?>
                      <?php if ($option_value['option_value_id'] == $product_option_value['option_value_id']) { ?>
                      <option style="background: #<?php echo $option_value['name']; ?>" value="<?php echo $option_value['option_value_id']; ?>" selected="selected"><?php echo $option_value['name']; ?></option>
                      <?php } else { ?>
                      <option style="background: #<?php echo $option_value['name']; ?>" value="<?php echo $option_value['option_value_id']; ?>"><?php echo $option_value['name']; ?></option>
                      <?php } ?>
                      <?php } ?>
                      <?php } ?>
                    </select>
