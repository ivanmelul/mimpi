        ...
        <table class="form">
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input id="optionName" type="text" <?php echo $es_color ? "readonly" : ''; ?> name="option_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($option_description[$language['language_id']]) ? $option_description[$language['language_id']]['name'] : ''; ?>" />
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              <td class="left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                ...
                <input type="text" class="optionValueInput"  name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][name]" <?php echo $es_color? "style='background-color:#". $option_value['option_value_description'][$language['language_id']]['name'] ."'": ''; ?> value="<?php echo isset($option_value['option_value_description'][$language['language_id']]) ? $option_value['option_value_description'][$language['language_id']]['name'] : ''; ?>" />
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
...
function addOptionValue() {
	...
	<?php foreach ($languages as $language) { ?>
	html += '<input type="text"  class="optionValueInput" name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][name]" value="" /> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />';
    <?php } ?>
	html += '</td>';
...
<script type="text/javascript"><!--
$(function(){
  //Si la opcion es color, crear color picker.
  if($("#optionName").val() == "Color"){
    crearColorPicker();
  }
});
