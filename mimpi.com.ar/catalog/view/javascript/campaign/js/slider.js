$(function() {
    ...
    function openGallery(){
        ...
        var $fp_content_wrapper = $fp_thumbContainer.find('.slider-container:nth-child('+parseInt(gallery_idx+1)+')');
        //hide all the other galleries thumbs wrappers
        $fp_thumbContainer.find('.slider-container').not($fp_content_wrapper).hide();
        //and show this one
		...
		*/
        ...
        $fp_content_wrapper.find('.slider-content')
    ...
    $fp_close.bind('click',function(){
        ...
        //the current thumb
        var $current 		= $fp_thumbScroller.find('.slider-container:nth-child('+parseInt(gallery_idx+1)+')')
        .find('.slider-content:nth-child('+parseInt(current+1)+')');
    ...
    function slideThumb(way){
        if(way==1){
            ++current;
            var $next = $fp_thumbScroller.find('.slider-container:nth-child('+parseInt(gallery_idx+1)+')')
            .find('.slider-content:nth-child('+parseInt(current+1)+')');
            if($next.length > 0)
            ...
            --current;
            var $prev = $fp_thumbScroller.find('.slider-container:nth-child('+parseInt(gallery_idx+1)+')')
            .find('.slider-content:nth-child('+parseInt(current+1)+')');
            if($prev.length > 0)
    ...
    function checkClosest(){
        ...
        var idx					= 0;	
        $container				= $fp_thumbScroller.find('.slider-container:nth-child('+parseInt(gallery_idx+1)+')');
        $container.find('.slider-content').each(function(i){
            var $obj 		= $(this);
            //the offset left of the element
            var obj_left 	= $obj.offset().left;
            //the center of the element is its offset left plus 
        ...
        var $new_current 	= $container.find('.slider-content:nth-child('+parseInt(idx+1)+')');
